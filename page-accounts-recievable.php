    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-2/3">
            ...
            <section class="mb-16">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600 mt-2">
                            <strong>Insurance Companies:</strong> Our experts perform consistent follow-up on overdue claims from the insurance companies. We also track claim status to find out whether the claim is under review or denied. Reviewing the status can also identify any missing documentation. We resubmit those documents to handle AR timely.
                        </p>
                        <p class="text-gray-600 mt-2">
                            <strong>Patients:</strong> We follow up on the due payments from patients by a step-by-step process:
                        </p>
                        <ul class="list-disc list-inside text-gray-600 ml-4">
                            <li>We send out monthly patient statements for three months</li>
                            <li>Our Virtual Assistant then calls them to help make payment through a secure mode</li>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600 mt-2">
                            Once we find out the reason for the denial, it gets easier to correct and resubmit the claims. Our team keeps track of resubmissions to ensure the payment is processed.
                        </p>
                        <p class="text-gray-600 mt-2">
                            Our experts recover revenue to maximize reimbursements. A detailed root-cause analysis can prevent claims from denial in the future.
                        </p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600">
                            If our team does not agree with the denial, we file for an appeal. Sometimes, the insurance accepts the appeal, but other times, it will go unanswered. In that case, we would file an appeal for the second time.
                        </p>
                        <p class="text-gray-600 mt-2">
                            Prime Doc Billing remains consistent with getting reimbursements to provide financial health to your practice.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">Aging Report Analysis</h3>
                        <p class="text-gray-600">
                            Prime Doc Billing proves to be an expert in Aging Report Analysis. It refers to understanding how long the payments are due and from which payer. We perform this analysis in 30-day sections. Our team determines the overdue payments in this time bracket to perform follow-ups.
                        </p>
                        <p class="text-gray-600 mt-2">
                            This analysis also helps us understand the payer performance by determining which ones are causing frequent delays. Our team sets policies for those payers to avoid such outstanding balances in the future.
                        </p>
                    </div>
            ...
            <section class="mb-16">
                ...
                <div class="bg-teal-50 border-l-4 border-teal-500 p-6 mb-8">
                    ...
                    <ul class="list-disc list-inside text-gray-700 ml-4">
                        <li>The patients’ and providers’ demographics</li>
                        <li>Services rendered</li>
                        <li>ICD and CPT diagnosis codes</li>
                        <li>Fee structure.</li>
                    </ul>
                </div>
                <p class="text-lg text-gray-600 leading-relaxed">
            ...
            <section class="mb-16">
                ...
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    The overall metrics of Accounts Receivable management vary from aging reports to collection ratios. Our team utilizes this information to understand the practice’s financial performance. We make the most of it in strategic planning and better decision-making for a better cash flow. We also recover old and lost revenue, giving your practice strong financial health.
                </p>
                <div class="bg-teal-50 border-l-4 border-teal-500 p-6 mb-8">
                    <p class="text-gray-700">
                        Prime Doc Billing guarantees systemized AR management services to make your practice thrive.
                    </p>
                </div>
            </section>
            ...
            <section class="mb-16">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-gray-600">
                                We also handle patients’ confidential data with adherence to HIPAA.
                            </p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-gray-600">
                                Prime Doc Billing’s administrative workflows align with the Practice Management Services and Electronic Health Record for faster claim submission and reimbursements.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="mb-16">
                ...
                <div class="space-y-6">
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">Onboarding and AR Data Review</h3>
                        <p class="text-gray-600">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">AR Segmentation and Prioritization</h3>
                        <p class="text-gray-600">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">Ongoing Follow-ups and Weekly Reports</h3>
                        <p class="text-gray-600">
            ...
            <!-- Section 7: Results-Driven Accounts Receivable Management Services -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Results-Driven Accounts Receivable Management Services</h2>
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    Prime Doc Billing's strategic approach to AR management helps recover lost revenue. Our team resubmits aging claims and consistently recovers a minimum of 40% revenue.
                </p>
                <div class="bg-teal-50 border-l-4 border-teal-500 p-6 mb-8">
                    <p class="text-gray-700">
                        Our experts plan and carry out results-driven programs for faster reimbursement cycles. The primary goal is to bring financial health to your business.
                    </p>
                </div>
            </section>

            <!-- Section 8: Begin Your Journey to Better AR Recovery with Prime Doc Billing -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Begin Your Journey to Better AR Recovery with Prime Doc Billing</h2>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            <button class="w-full flex justify-between items-center" aria-expanded="false">
                                <h3 class="text-lg font-medium text-gray-800 text-left">What’s included in your Accounts Receivable management services?</h3>
                            ...
                            <div class="mt-3 text-gray-600 hidden">
                                <p>Our AR Management services involves a series of steps which includes:</p>
                                <ul class="list-disc list-inside ml-4">
                                    <li>Creating and sending invoices</li>
                                    <li>Having follow-ups</li>
                                    <li>Data cleanup</li>
                                    <li>Aging report</li>
                                    <li>Claim review and resubmission</li>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            ...
                            <div class="mt-3 hidden text-gray-600">
                                <p>We use a data-driven approach to document claim submission to help reduce AR days. Dividing the aging AR into segments helps us identify the most profitable claims.</p>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            ...
                            <div class="mt-3 hidden text-gray-600">
                                <p>Prime Doc Billing understands the needs of every specialty. Hence make a service plan according to the provider’s requirement.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-8 bg-gray-50 p-6 rounded-xl">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm text-gray-600">Maximized Reimbursements</span>
                        </div>
                    </div>
                </div>
            </div>
