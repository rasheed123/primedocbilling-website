...
<section class="pb-10 lg:pb-16">
    ...
    <div class="2xl:max-w-[1284px] xl:max-w-[1152px] lg:max-w-[984px] md:max-w-[744px] sm:max-w-[100%] px-6 sm:px-3
                mx-auto">
        <div class="md:grid gap-14 max-w-[1024px] mx-auto place-items-center">
            <div class="flex flex-col gap-8 md:gap-10 mt-10 md:mt-0">
                <div>
                    <h3 class="capitalize text-[24px] text-gray-900 font-semibold my-4 border-b" data-aos="fade-up">
                        The 3Ps
                    </h3>
                    ...
                    <p class="text-gray-600 leading-7" data-aos="fade-up">
                        Our team is dedicated to ensuring that every code, claim, and document is handled with meticulous attention to detail. By prioritizing precision, we guarantee that healthcare providers receive the maximum reimbursement they deserve.
                    </p>
                </div>
                <div>
                    <h3 class="capitalize text-[20px] mb-2 text-gray-700 font-semibold" data-aos="fade-up">
                    ...
                    <p class="text-gray-600 leading-7" data-aos="fade-up">
                        We uphold the highest standards of professionalism in every interaction. Our staff is not only highly skilled but also courteous and respectful. We believe that professionalism is the cornerstone of trust, and we aim to build trust with each client we serve.
                    </p>
                </div>
                <div>
                    <h3 class="capitalize text-[20px] mb-2 text-gray-700 font-semibold" data-aos="fade-up">
                    ...
                    <p class="text-gray-600 leading-7" data-aos="fade-up">
                        At Prime Doc Billing LLC, we recognize that behind every claim is a patient seeking quality care. That's why we put the patient at the heart of our operations. We strive to make the billing process seamless and transparent, ensuring that patients can focus on their health without worrying about financial complexities.
                    </p>
                </div>
                <div>
                    <h3 class="capitalize text-[24px] text-gray-900 font-semibold my-4 border-b" data-aos="fade-up">
