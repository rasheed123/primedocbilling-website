...
<div class="container mx-auto px-4 md:px-6 py-12 max-w-7xl">
    <div class="flex flex-col lg:flex-row gap-8">
        <!-- Content Column -->
        <div class="lg:w-2/3">
            <!-- Section 1: Challenges in NY Credentialing: From Delays to Denials -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Challenges in NY Credentialing: From Delays to Denials</h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600">
                            New York’s insurance agencies enforce re-credentialing cycles every 2-3 years. Prime Doc Billing prepares the providers for unannounced audits by the Department of Health (DOH).
                        </p>
                        <p class="text-gray-600">
                            Our team runs regular audits and tracks re-credentialing dates to prepare for timely renewals. We maintain providers’ profiles to ensure that we meet all payer requirements properly.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">Heavy Regulatory Oversight</h3>
                        <p class="text-gray-600">
                            New York has some of the strictest healthcare policies. The New York Department of Health (DOH) and the Office of Professional Medical Conduct (OPMC) enforce such policies. Prime Doc Billing conducts pre-submission risk reviews to avoid any errors.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">Excessive Documentation Burden</h3>
                        <p class="text-gray-600">
                            New York health plan often asks for a lot of documentation. We make sure to accurately submit every one of them while meeting the payers’ format. These documents include:
                        </p>
                        <ul class="list-disc list-inside text-gray-600 ml-4">
                            <li>Years of employment history</li>
                            <li>Hospital affiliations</li>
                            <li>Board certification proof</li>
                            <li>And more</li>
                        </ul>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">Closed or Selective Panels</h3>
                        <p class="text-gray-600">
                            Most of the insurance agencies in New York contain closed panels. This means that the providers often apply without knowing the credentialing slot availability status. Prime Doc Billing consults insurance representatives to ensure the slots are empty. We also file for strategic appeals if necessary.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">High Denial Rates</h3>
                        <p class="text-gray-600">
                            Even after a clean credentialing submission, the payers in New York often deny the requests. Prime Doc Billing prepares an appeal with backed-up data to support our credentialing. We also maintain communication with insurance representatives for proactive follow-up.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section class="mb-16">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Provider Intake and Profiling</h3>
                            <p class="text-gray-600">
                                We start by gathering all the required documents for provider credentialing intake. These documents include:
                            </p>
                            <ul class="list-disc list-inside text-gray-600 ml-4">
                                <li>NYS Professional License</li>
                            ...
                            <p class="text-gray-600">
                                We identify any errors that can cause delays in credentialing with insurers and correct them instantly.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">CAHQ Profile Setup</h3>
                            <p class="text-gray-600">
                                We create, update, and maintain your CAHQ profile to ensure data accuracy. Our experts also resolve any mission information that might delay your credentialing process. CAHQ profile setup is important because many New York providers heavily rely on it.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <ul class="list-disc list-inside text-gray-600 ml-4">
                                ...
                                <li>Attaching required documentation</li>
                                <li>Attestations</li>
                                <li>Repetitive follow-up</li>
                            </ul>
                            <p class="text-gray-600">
                                We understand each payer’s guidelines, such as response timelines, and tailor our strategies according to them.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Ongoing Monitoring and Follow-ups</h3>
                            <p class="text-gray-600">
                                We take weekly follow-ups with the insurers, since credentialing in New York can consume up to 90 days. Our team monitors the credentialing process timelines. We instantly communicate with network managers if our team notices any inconsistencies.
                            </p>
                            <p class="text-gray-600">
                                Prime Doc Billing stays ahead of re-credentialing dates to keep a smooth workflow for your practice.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Credentialing Finalization and Directory Accuracy</h3>
                            <p class="text-gray-600">
                                Once your credentialing is finalized, we ensure your demographics are accurately listed in insurance directories. New York insurers often delay uploading your status in their directories. That is why our experts stay in touch with payer teams to speed up your process.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Continuous Maintenance and Compliance</h3>
                            <p class="text-gray-600">
                                We offer re-credentialing of your practice with license renewal alerts. Our team keeps your CAHQ profile updated with regulatory audit preparation.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="mb-16">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Cash Flow Disruption</h3>
                        <p class="text-gray-600 text-sm">
                            Providers can not bill payers if they are not fully contracted with them. Prime Doc Billing monitors the timeline of every insurer. We credential you based on that timeline so that you can run your practice smoothly.
                        </p>
                        <p class="text-gray-600 text-sm">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600 text-sm">
                            New York has a dense healthcare market, which calls for provider competition. Prime Doc Billing gives you timely credentialing. This helps your practice get a business advantage in the competitive market of New York.
                        </p>
                    </div>
                </div>
            </section>

            <!-- Section 4: Work with a Local Credentialing Partner: Prime Doc Billing -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Work with a Local Credentialing Partner: Prime Doc Billing</h2>

                <div class="bg-teal-50 border-l-4 border-teal-500 p-6 mb-8">
                    <p class="text-gray-700">
                        If you are looking for expert Provider Credentialing Services in New York, then we are the right choice for you! We offer our comprehensive credentialing services to every specialty with no boundaries. Connect with us now or book a demo on our website.
                    </p>
                </div>
            </section>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            <button class="w-full flex justify-between items-center" aria-expanded="false">
                                <h3 class="text-lg font-medium text-gray-800 text-left">How long does provider credentialing take in New York?</h3>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            ...
                            <div class="mt-3 hidden text-gray-600">
                                <p>We support every healthcare specialty for credentialing in New York, from primary care to neurology.</p>
                            </div>
                        </div>
                    </div>
                </div>
