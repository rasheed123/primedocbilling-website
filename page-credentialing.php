    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="lg:w-2/3">
            ...
            <section class="mb-16">
                ...
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    By choosing us, you can guarantee faster approvals, fewer delays, and a streamlined process. We do not only simplify the entire process for you, but also keep your credentials up-to-date.
                </p>
            </section>

            <!-- Section 2: Prime Doc Billing’s Medical Credentialing Process -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Prime Doc Billing’s Medical Credentialing Process</h2>
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <ul class="list-disc list-inside text-gray-600 mt-3 space-y-1">
                            ...
                            <li>Ensure financial health for your career</li>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600">
                            The Council for Affordable Quality Healthcare (CAQH) is a government-based centre for healthcare professionals. Insurance companies use CAQH to verify providers’ credentials before approving their participation. Having a CAQH profile is important to expand your reach and boost visibility.
                        </p>
                        <p class="text-gray-600 mt-2">
                            Prime Doc Billing has the knowledge of specific requirements of different insurance companies which helps setting up the CAQH profile. Most companies require the providers to re-credential their information every 90 days.
                        </p>
                        <p class="text-gray-600 mt-2">
                            We help you maintain an accurate and up-to-date CAQH profile for faster approvals and reimbursements. A well-maintained profile reflects professionalism, hence encouraging better payer relationships.
                        </p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <h3 class="text-xl font-semibold text-sky-700 mb-3">Hospital Privileges</h3>
                        <p class="text-gray-600">
                            Hospital privileges allow a provider to work on hospital premises and perform procedures. Prime Doc Billing’s experts help the providers get Primary Source Verification (PSV) required by law.
                        </p>
                        <p class="text-gray-600 mt-2">
                            We take consistent follow-ups with the hospital’s office and respond to any need for documentation.
                        </p>
                    </div>
                </div>
            </section>

            <!-- Section 3: A Complete Guide to Prime Doc Billing’s Credential and Enrollment Services -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">A Complete Guide to Prime Doc Billing’s Credential and Enrollment Services</h2>
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    Enrollment with insurance companies begins after the credentialing process. Completing the enrollment process requires submitting documents and getting approvals. After that, a provider can submit claims and get reimbursements for their services.
                </p>
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Medicare & Medicaid Enrollment</h3>
                            <p class="text-gray-600">
                                Medicare refers to the insurance of patients aged 65 and above and those with certain disabilities. Medicaid insurance covers patients with limited income and resources. Providers must enroll with both types of federal health insurance to get reimbursements.
                            </p>
                            <p class="text-gray-600 mt-2">
                                Prime Doc Billing helps you enroll in these networks by filling out paperwork. We also perform other processes like license verification, background checks, and registering for a National Provider Identification (NPI) number.
                            </p>
                            <p class="text-gray-600 mt-2">
                                We track the status of your application and fix any rejections with the help of credentialing software.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Commercial Insurance Credentialing</h3>
                            <p class="text-gray-600">
            ...
            <!-- Section 4: Credentialing By Specialty -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Credentialing By Specialty: From Application to Approval</h2>
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    We understand the unique requirements of specialties as they vary in the credentialing process. We offer credentialing for all kinds of specialties in all the states of the USA. Some of them are mentioned below:
                </p>

                <div class="grid md:grid-cols-2 gap-6">
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <div class="text-teal-600 text-2xl mb-3">➔</div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Physicians</h3>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600 text-sm">
                            Physical Therapists are required to have a Doctor of Physical Therapy (DPT) degree. We check if PT has graduated from a CAPTE-accredited program and has proof of work history.
                        </p>
                        <p class="text-gray-600 text-sm mt-2">
                            An OT must have a National Board for Certification in Occupational Therapy (NBCOT) certificate. We start by gathering all essential documents. And then complete the necessary forms for validation.
                        </p>
                        <p class="text-gray-600 text-sm mt-2">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600 text-sm">
                            Prime Doc Billing verifies whether the ASC has:
                        </p>
                        <ul class="list-disc list-inside text-gray-600 text-sm mt-2 space-y-1">
                            <li>Federal and commercial credentialing</li>
                            <li>A state surgical facility license</li>
                            <li>NPI</li>
                        </ul>
                        <p class="text-gray-600 text-sm mt-2">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        ...
                        <p class="text-gray-600 text-sm">
                            Since they work in a group, we help them get Type 2 NPI. Our experts also check their licenses and documentation to prevent future denials.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <div class="text-teal-600 text-2xl mb-3">➔</div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Behavioral Health Providers</h3>
                        <p class="text-gray-600 text-sm">
                            They are the fastest-growing practitioners who need both types of NPI. Prime Doc Billing helps them get approved for telehealth billing, which requires the verification of multi-state licenses and a compliance guide.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <div class="text-teal-600 text-2xl mb-3">➔</div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Chiropractors</h3>
                        <p class="text-gray-600 text-sm">
                            Prime Doc Billing helps them with:
                        </p>
                        <ul class="list-disc list-inside text-gray-600 text-sm mt-2 space-y-1">
                            <li>State chiropractic license verification</li>
                            <li>Board certification</li>
                            <li>CAQH profile.</li>
                        </ul>
                        <p class="text-gray-600 text-sm mt-2">
                            We provide them with a medicare documentation audit to reduce the chances of denial.
                        </p>
                    </div>

                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <div class="text-teal-600 text-2xl mb-3">➔</div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Diagnostic Testing Facilities</h3>
                        <p class="text-gray-600 text-sm">
                            Diagnostic Testing Facilities must credential themselves with insurance companies so they get reimbursements for tests and Xrays. We help them with:
                        </p>
                        <ul class="list-disc list-inside text-gray-600 text-sm mt-2 space-y-1">
                            <li>CLIA certification tracking</li>
                            <li>Commercial payer enrollments</li>
                            <li>Type 2 NPI</li>
                            <li>CAHQ updates.</li>
                        </ul>
                    </div>
            ...
            <!-- Section 5: Why Trust Prime Doc Billing for Credentialing? -->
            <section class="mb-16">
                <h2 class="text-3xl font-bold text-gray-800 mb-6">Why Trust Prime Doc Billing for Credentialing?</h2>

                <div class="bg-teal-50 border-l-4 border-teal-500 p-6 mb-8">
                    <p class="text-gray-700">
                        We possess the understanding of the state, federal, and private insurance company policies. We stay up-to-date with their regulations to ensure compliance and cut delays.
                    </p>
                </div>
                <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                    We have handled many complex cases with a proven track record. That makes us one of the best medical billing credentialing options in the industry. And the trusted choice for your healthcare practice.
                </p>
            </section>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            <button class="w-full flex justify-between items-center" aria-expanded="false">
                                <h3 class="text-lg font-medium text-gray-800 text-left">What is the credentialing process, and how long does it take?</h3>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            ...
                            <div class="mt-3 hidden text-gray-600">
                                <p>We understand the needs of every specialty and perform the credentialing process accordingly.</p>
                            </div>
                        </div>
                    </div>
                </div>
