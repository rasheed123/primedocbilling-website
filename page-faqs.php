...
<section class="section-services section-services--about py-8 mb-12">
    ...
    <div class="max-w-[950px] flex flex-col gap-4 text-center mx-auto">
        ...
        <!--    your-->
        <!--    practice The under-mentioned reasons can justify the need of outsourcing medical billing operations to-->
        <!--    scale-->
        <!--    up your practice The under-mentioned reasons can justify the need of outsourcing medical billing-->
        <!--    operations-->
        <!--    to scale up your practiceur practice-->
        <!--</p>-->
</section>
...
<section class="py-8">
    <div class="2xl:max-w-[1284px] xl:max-w-[1152px] lg:max-w-[984px] md:max-w-[744px] sm:max-w-[100%] px-6 sm:px-3 mx-auto">
        <ul class="divide-y">
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>How are you HIPAA compliant?</span>
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>Why should I choose Prime Doc Billing LLC over other companies?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>Is your team certified?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>What is your approach to my account?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>Why I should outsource medical billing operations?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>What if I want to outsource just a portion or specific area of my practice? Can it be done through an outsourcing model?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>How does working with Prime Doc impact my practice?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
                    Working with Prime Doc positively impacts your practice by optimizing revenue collection, reducing billing errors, and improving cash flow. Our expertise and technology-driven solutions increase your healthcare practice's profitability and better financial stability.
                </p>
            </li>
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>How will I get to know the progress of my practice?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
                    We maintain open communication with our clients. In addition to regular weekly meetings, we conduct management meetings with the practice owner or manager to review our team's performance, address concerns, and ensure transparency in tracking the progress of your practice.
                </p>
            </li>
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>What is the typical turnaround time for claims processing and payments?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
                    Our goal is to process claims promptly. The typical turnaround time for claims processing and payments can vary but is often within 30 to 60 days, depending on the complexity and specific insurance providers involved.
                </p>
            </li>
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>How do you handle claim denials and appeals?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
                    We have a dedicated team experienced in handling claim denials and appeals. When a claim is denied, we promptly investigate the reasons, rectify any errors, and resubmit the claim. If necessary, we persistently pursue the appeals process to ensure maximum reimbursement for your practice.
                </p>
            </li>
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>Do you provide regular reports and updates on our practice's financial performance?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
                    Yes, we offer regular reports and updates to inform clients about their practice's financial status. We communicate financial performance through scheduled meetings and detailed reports, providing transparency and insights.
                </p>
            </li>
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>Do you offer a free consultation or assessment for potential clients?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
            ...
            <li class="capitalize text-[#3F3F46] font-medium text-[16px] md:text-[20px] p-4 border-t overflow-hidden accordion__item" data-aos="fade-up">
                <div class="flex justify-between cursor-pointer items-center">
                    <span>How can I get started with your medical billing services?</span>
                    <img src="<?php echo get_theme_file_uri() ?>/assets/images/accordion_plus.png" alt="icon" class="w-8 h-8 md:w-10 md:h-10" />
                </div>
                <p class="text-[#52525B] font-light text-[16px] mt-3 leading-[28px] hidden">
