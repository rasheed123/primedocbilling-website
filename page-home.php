  ...
  <div class="2xl:max-w-[1284px] xl:max-w-[1152px] lg:max-w-[984px] md:max-w-[744px] sm:max-w-[100%] px-6 sm:px-3 mx-auto">
    <div class="max-w-3xl mx-auto text-center mb-16">
      <h2
        ...
        Whom We Serve
        <span
          class="absolute -bottom-2 left-1/2 -translate-x-1/2 w-24 h-1 rounded-full bg-[#3873CC]"></span>
      </h2>
      <p
...
<section
  ...
  <a
    ...
    class="inline-block bg-gradient-to-r from-[#3873CC] to-[#2a54a0] hover:from-[#2a54a0] hover:to-[#1f3f7a] text-white font-semibold text-lg px-14 py-5 rounded-full shadow-lg transition-transform transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[#3873CC]/50"> Book a Demo</a>
  <div
    aria-hidden="true"
    class="absolute -top-24 -left-24 w-64 h-64 rounded-full bg-gradient-to-tr from-[#3873CC]/30 to-transparent blur-3xl pointer-events-none"></div>
  <div
    aria-hidden="true"
    class="absolute -bottom-24 -right-24 w-64 h-64 rounded-full bg-gradient-to-br from-[#2a54a0]/30 to-transparent blur-3xl pointer-events-none"></div>
</section>
