...
<head>
    ...
    <title>Medical Billing Services in the USA - Prime Doc Billing</title>
        ...
        <div class="lg:w-2/3">
            ...
            <section class="mb-16">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition duration-300">
                        <div class="text-teal-600 text-2xl mb-3">➔</div>
                        <h3 class="text-xl font-semibold text-gray-800 mb-2">Customized billing solutions customized to fit your specialty and practice size</h3>
                    </div>
                </div>
            </section>
            ...
            <section class="mb-16">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Medical coding & documentation</h3>
                            <p class="text-gray-600">
                                We ensure your documentation aligns with ICD-10 and CPT coding standards, minimizing errors and maximizing claim acceptance. Regular audits safeguard your revenue and maintain compliance.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">End-to-end revenue cycle management</h3>
                            <p class="text-gray-600">
                                To ensure faster reimbursements and improved cash flow, we handle the entire revenue cycle, including:
                            </p>
                            <ul class="list-disc list-inside text-gray-600 ml-4">
                                <li>Patient registration and insurance verification</li>
                                <li>Medical coding and claim submission</li>
                                <li>Payment posting and account reconciliation</li>
                                <li>Accounts receivable management for faster cash flow</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Provider credentialing & re-credentialing</h3>
                            <p class="text-gray-600">
                                Our fast and efficient credentialing services help providers enroll with insurers quickly. We also manage compliance, handle follow-ups, and maintain status with major payers for uninterrupted revenue flow.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Claim submission & denial management</h3>
                            <p class="text-gray-600">
                                Our experts submit clean, error-free claims on time, track denials, and handle resubmissions efficiently. We reduce rejections and recover lost revenue to keep your finances healthy.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Insurance verification & authorization</h3>
                            <p class="text-gray-600">
                                We verify patient insurance details beforehand and acquire prior authorizations when needed. This approach prevents coverage-related denials and ensures a smoother billing process.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Patient billing & collections</h3>
                            <p class="text-gray-600">
                                We provide clear, easy-to-understand patient statements and handle follow-ups on outstanding balances. Flexible payment options ensure patient satisfaction while improving your collection rates.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Compliance & regulatory support</h3>
                            <p class="text-gray-600">
                                We ensure your practice stays HIPAA-compliant and adheres to CMS and payer guidelines. Our team stays updated on regulatory changes, providing ongoing staff training to keep you risk-free.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Reporting & analytics</h3>
                            <p class="text-gray-600">
                                Data drives smarter decisions. We deliver customized financial reports, performance analysis, and predictive insights, empowering you to optimize revenue cycles, spot inefficiencies, and enhance financial planning for sustainable growth.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                We take pride in revolutionizing patient interactions with our Virtual Medical Scribe Solutions. We handle real-time documentation, allowing you to focus on delivering distraction-free patient care.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                Speed up access to care with our prior authorization services. We handle the approval process smoothly and accurately, reducing claim denials and helping patients get the necessary treatments on time.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                Establish a strong digital presence with our top-notch website development services. We design high-performing, user-friendly websites to fit your practice’s goals, helping you attract more patients and grow your business.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                We offer customized billing solutions that streamline your financial operations, ensuring faster reimbursements and improved cash flow. Focus on growing your practice while we handle the billing complexities.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Hospitals and healthcare facilities</h3>
                            <p class="text-gray-600">
                                Our end-to-end revenue cycle management supports large-scale hospital operations. From patient registration to final payment, we accurately manage high-volume billing transactions, reducing administrative burdens and accelerating revenue collection.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                We understand the fast-paced nature of urgent care. Our billing services ensure rapid claim processing and accurate reimbursement, keeping your practice running smoothly.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Specialty clinics (e.g., Cardiology, Orthopedics, Dermatology)</h3>
                            <p class="text-gray-600">
                                Specialty practices face unique coding and billing challenges. We provide customized solutions to manage complex procedures and secure maximum reimbursements, helping you maintain financial stability.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">
                                From family physicians to specialists, we provide accurate, efficient billing solutions to tackle doctors' distinct financial challenges and ensure timely and correct payments.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Nurse practitioners</h3>
                            <p class="text-gray-600">
                                We also provide comprehensive billing services to increase revenue growth for nurse practitioners. Now, you can focus on delivering top-notch patient care while we handle the billing intricacies to boost your financial success.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Laboratories</h3>
                            <p class="text-gray-600">
                                We streamline laboratory billing processes, ensuring precise claims submission and faster reimbursements so you can focus on delivering accurate diagnostic results.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Medical billing companies</h3>
                            <p class="text-gray-600">
                                Finally, we offer flexible, scalable support to other billing companies too. Our dynamic approach helps you achieve consistent financial success while improving client satisfaction.
                            </p>
                        </div>
                    </div>
                </div>

                <div class="bg-teal-50 border-l-4 border-teal-500 p-6 mt-8">
                    <p class="text-gray-700">
            ...
            <section class="mb-16">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Certified medical billing specialists</h3>
                            <p class="text-gray-600">
                                Experts familiar with regional payors and state-specific compliance.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Lower overhead costs</h3>
                            <p class="text-gray-600">
                                Skip the in-house billing team and cut expenses.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Real-time reporting</h3>
                            <p class="text-gray-600">
                                Get live updates on claims and revenue performance.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Claim scrubbing</h3>
                            <p class="text-gray-600">
                                Minimize rejections with proactive claim scrubbing.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="mb-16">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Boosted revenue with fewer claim denials</h3>
                            <p class="text-gray-600">
                                Will get you paid faster and more accurately.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">More time for patient care</h3>
                            <p class="text-gray-600">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Timely claims and faster reimbursements</h3>
                            <p class="text-gray-600">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">Clear, transparent billing practices</h3>
                            <p class="text-gray-600">
                                Will improve your patient’s satisfaction.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            <button class="w-full flex justify-between items-center" aria-expanded="false">
                                <h3 class="text-lg font-medium text-gray-800 text-left">What makes Prime Doc Billing different from other billing companies?</h3>
                        ...
                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            ...
                            <div class="mt-3 hidden text-gray-600">
                                <p>Many practices see improvements within the first few billing cycles, including faster payments, fewer denials, and better cash flow management. Book a free consultation to get a detailed plan.</p>
                            </div>
                        </div>

                        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 transition duration-300 hover:shadow-md accordion__item">
                            <button class="w-full flex justify-between items-center" aria-expanded="false">
                                <h3 class="text-lg font-medium text-gray-800 text-left">Will I get detailed financial reports with your billing services?</h3>
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-teal-600" viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd" />
                                </svg>
                            </button>
                            <div class="mt-3 hidden text-gray-600">
                                <p>Yes, our medical billing services include comprehensive performance reports, offering reviews into revenue trends, claim success rates, and denial management to keep you informed.</p>
                            </div>
                        </div>
                    </div>
                </div>
